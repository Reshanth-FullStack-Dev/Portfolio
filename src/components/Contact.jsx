...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // EmailJS configuration - fallback to hardcoded values for production
    const SERVICE_ID = import.meta.env.VITE_EMAILJS_SERVICE_ID || 'service_cuvdjw8'
    const TEMPLATE_ID = import.meta.env.VITE_EMAILJS_TEMPLATE_ID || 'template_437nogj'
    const PUBLIC_KEY = import.meta.env.VITE_EMAILJS_PUBLIC_KEY || '8iUrXhv66tmsQGnTb'
